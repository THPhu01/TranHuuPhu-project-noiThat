...
<div class="col-md-10">
    <div class="panel">
        ...
        <div class="panel-body">
            <form action="{{ Route ('sanphams.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                            <input type="text" class="form-control" name="tenSP" placeholder="Nhập tên sản phẩm..." id="username12">
                        </div>
                                @error('tenSP')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="giaGoc" placeholder="Nhập giá gốc..." id="username12">
                        </div>
                                @error('giaGoc')
                                     <span style="color:red">Lỗi : {{ $message }}</span>
                                @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-money"></i></span>
                            <input type="number" class="form-control" name="giaKM" placeholder="Nhập giá khuyến mãi..." id="username12">
                        </div>
                                @error('giaKM')
                                     <span style="color:red">Lỗi : {{ $message }}</span>
                                @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="soLuong" placeholder="Nhập số lượng..." id="username12">
                        </div>
                                @error('soLuong')
                                     <span style="color:red">Lỗi : {{ $message }}</span>
                                @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <textarea style="height: 150px;" class="form-control" name="moTa" placeholder="Nhập mô tả..." id="editor1" ></textarea>
                        </div>
                                @error('moTa')
                                     <span style="color:red">Lỗi : {{ $message }}</span>
                                @enderror
