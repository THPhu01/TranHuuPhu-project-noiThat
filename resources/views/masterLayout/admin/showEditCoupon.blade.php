...
<div class="col-md-10">
    <div class="panel">
        ...
        <div class="panel-body">
            <form action="{{ route('coupons.update' , ['coupon' => $editCoupon->id]) }}" method="post" class="form-horizontal">
                @csrf
                @method('PATCH')
                <div class="form-group">
                    <label for="username12" class="col-sm-3 control-label"> ID </label>
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                            <input type="text" class="form-control" name="id" value="{{$editCoupon->id}}" readonly id="username12">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                            <input type="text" class="form-control" name="coupon" value="{{$editCoupon->coupon}}" id="username12">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" name="ngayBD" value="{{$editCoupon->ngay_bat_dau}}" id="username12">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calculator"></i></span>
                            <input type="date" class="form-control" name="ngayKT" value="{{$editCoupon->ngay_ket_thuc}}" id="username12">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <textarea style="height: 150px;" class="form-control" name="moTa" id="username12" >{{$editCoupon->mo_ta}}</textarea>
                        </div>
                    </div>
                </div>
